...
public class SanitationServiceRequestFactory {
    ...
    private static final SanitationServiceRequestFactory factory = new SanitationServiceRequestFactory();
    private static final ServiceRequestFactory serviceRequestFactory = ServiceRequestFactory.getFactory();
