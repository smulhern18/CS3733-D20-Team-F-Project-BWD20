...
public class MedicineDeliveryRequestFactory {
    ...
    private static final MedicineDeliveryRequestFactory factory = new MedicineDeliveryRequestFactory();
    ...
    public List<MedicineDeliveryRequest> getAllMedicineDeliveryRequests() {
        ...
        String selectStatement = "SELECT * FROM " + DatabaseManager.MEDICINE_DELIVERY_REQUEST_TABLE_NAME;
        ...
        try (PreparedStatement preparedStatement =
            ...
            System.out.println(
                    "Exception in MedicineDeliveryRequestFactory read: " + e.getMessage() + ", " + e.getClass());
        }
        return medicineDeliveryRequests;
    }
}
