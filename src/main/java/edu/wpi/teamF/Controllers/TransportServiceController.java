...
public class TransportServiceController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // desc column
        JFXTreeTableColumn<UITransportRequest, String> desc =
        ...
        // priority column
        JFXTreeTableColumn<UITransportRequest, String> priority =
    ...
    // assignee column
    JFXTreeTableColumn<UITransportRequest, String> assignee =
    ...
    completed.setCellValueFactory(
        ...
        JFXTreeTableColumn<UITransportRequest, String> column =
                new JFXTreeTableColumn<>("Assignee");
    ...
    public void update(ActionEvent actionEvent) throws Exception {
        for (UITransportRequest csrui : csrUI) {
            TransportRequest toUpdate =
                    databaseManager.readTransportRequest(csrui.getID().get());
