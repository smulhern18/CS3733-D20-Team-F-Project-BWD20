...
public class SanitationServiceController implements Initializable {
  ...
  SanitationServiceRequestFactory sanitationServiceRequest =
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    treeTableSanitation.getColumns().setAll(ID, loc, type, desc, priority, assignee, completed);
  ...
  public void delete(ActionEvent actionEvent) {
    ...
    csrUI.removeIf(sanitationServiceRequest -> sanitationServiceRequest.getID().get().equals(toDelte));
    deleteText.setText("");
    treeTableSanitation.refresh();
  }
}
