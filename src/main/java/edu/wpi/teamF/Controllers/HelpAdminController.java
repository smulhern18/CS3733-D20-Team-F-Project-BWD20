...
public class HelpAdminController implements Initializable {
    ...
    content8.setBody(
        new Text(
            "1.\tGo to Tools page.\n"
                ...
                + "4.\tThe articles can be sent to mobile phone by entering you phone number.\n"
  ...
  private void translate(ActionEvent actionEvent) {
    ...
    content9.setHeading(new Text("How do I use a translator?"));
    content9.setBody(
        new Text(
            "1.\tGo to Tools page.\n"
                + "2.\tSelect the languages to translate from and translate to. \n"
                + "3.\tEnter text to translate. Click on 'Translate'.\n"
                + "4.\tTranslated text can be sent to your mobile phone via text message.\n"
                + "5.\tTranslated text can also be called to mobile phone and heard verbally.\n"));
  ...
  private void room(ActionEvent actionEvent) {
    ...
    content10.setHeading(new Text("How do I request a room?"));
    content10.setBody(
        new Text(
            "1.\tGo to Service Request.\n"
                ...
                + "5.\tRight click on a created event to set detailed information or delete it. \n"));
  ...
  private void ship(ActionEvent actionEvent) {
    ...
    content11.setHeading(new Text("How do I ship items?"));
    content11.setBody(
        new Text(
            "1.\tGo to Tools page.\n"
                + "2.\tClick on 'Shipping'.\n"
                ...
                + "5.\tVerified Address and Shopping Labels will be generated.\n"
                + "6.\tPrint or view shipping labels.\n"
                + "7.\tTracking numbers can be sent to  your mobile phone. \n"));
  ...
  private void map(ActionEvent actionEvent) {
    ...
    content12.setHeading(new Text("How do I edit the map?"));
    content12.setBody(
        new Text(
            "1.\tGo to Map Editor page.\n"
                + "2.\tClick on 'Add Node' or 'Add Edge'. \n"
                + "3.\tEnter relevant information of node or edge that is to be added. \n"
                + "4.\tClicking on a present node or edge allows admin to modify or delete it.\n"));
  ...
  private void account(ActionEvent actionEvent) {
    ...
    content13.setHeading(new Text("How do I manage accounts?"));
    content13.setBody(
        new Text(
            "1.\tGo to Admin page.\n"
  ...
  private void specificsr(ActionEvent actionEvent) {
    ...
    content14.setHeading(new Text("How do I keep track of specific service requests?"));
    content14.setBody(
        new Text(
            "1.\tGo to Service Request page.\n"
                ...
                + "\n"
                + "For advanced management of maintenance, transportation, and sanitation service requests:\n"
                + "1.\tGo to Admin page. \n"
                + "2.\tClick on 'Report View'.\n"
                + "3.\tEmployees, most common locations, and completed requests are shown in the chart.\n"
  ...
  private void updatepa(ActionEvent actionEvent) {
    ...
    content16.setHeading(new Text("How do I update the pathfinding algorithm?"));
    content16.setBody(
        new Text(
            "1.\tGo to Admin page.\n"
                + "2.\tSelect an algorithm (A-Star, DFS, BFS or Dijkstra’s) for pathfinder. \n"));
