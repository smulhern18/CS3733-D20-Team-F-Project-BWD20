...
public class MaintenanceRequestController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // priority column
        JFXTreeTableColumn<UIMaintenenceRequest, String> priority = new JFXTreeTableColumn<>("Priority");
        ...
        JFXTreeTableColumn<UIMaintenenceRequest, String> column =
        ...
        column.setOnEditCommit(
                new EventHandler<TreeTableColumn.CellEditEvent<UIMaintenenceRequest, String>>() {
                    @Override
                    public void handle(
                            TreeTableColumn.CellEditEvent<UIMaintenenceRequest, String> event) {
