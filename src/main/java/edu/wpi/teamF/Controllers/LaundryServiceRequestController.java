...
import edu.wpi.teamF.DatabaseManipulators.LaundryServiceRequestFactory;
...
public class LaundryServiceRequestController implements Initializable {
    ...
    List<LaundryServiceRequest> laundryServiceRequests =
            databaseManager.getAllLaunduaryRequests();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Location column
        JFXTreeTableColumn<UILaundryServiceRequest, String> loc =
    ...
    public void update(ActionEvent actionEvent)
        ...
        for (UILaundryServiceRequest lsrUI : isrUI) {
            LaundryServiceRequest toUpdate = databaseManager.readLaundryServiceRequest(lsrUI.getID().get());
