...
public class MedicineDeliveryRequest extends ServiceRequest{
    ...
    public MedicineDeliveryRequest(
            ...
            int priority,
            boolean complete, String medicineType, String instructions)
    ...
    public MedicineDeliveryRequest(
            Node location, String description, String assignee, Date dateTimeSubmitted, int priority, String medicineType, String instructions)
            throws ValidationException {
