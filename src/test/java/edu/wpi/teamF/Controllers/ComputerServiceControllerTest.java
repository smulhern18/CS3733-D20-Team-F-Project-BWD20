...
public class ComputerServiceControllerTest extends ApplicationTest{
    ...
    //Initialize the databases needed. Need database manager, nodes (for locations) and obv. the computerservicerequest
    private static DatabaseManager db = new DatabaseManager();
    private static NodeFactory nodes = NodeFactory.getFactory();
    private static ComputerServiceRequestFactory computerServiceRequestFactory = ComputerServiceRequestFactory.getFactory();
