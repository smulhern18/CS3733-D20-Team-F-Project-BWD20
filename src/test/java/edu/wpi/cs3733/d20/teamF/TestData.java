...
public class TestData {
  ...
  public Date[] validEstimatedCompletion = {
    new Date(9), new Date(99), new Date(200), new Date(1500)
  };
  public String[] validMaintenanceTypes = {"Landscaping", "Plumbing", "Electrical", "HVAC"};
  public double[] validEstimatedCosts = {2000.00, 3000.99, 20.31, 156.12};
  ...
  public MaintenanceRequest[] validMaintenanceRequests = {
    new MaintenanceRequest(
        ...
        validDates[0],
        2,
        validMaintenanceTypes[0],
        validEstimatedCompletion[0],
        validEstimatedCosts[0],
        true,
    ...
    new MaintenanceRequest(
        ...
        validDates[1],
        2,
        validMaintenanceTypes[1],
        validEstimatedCompletion[1],
        validEstimatedCosts[1],
        false,
    ...
    new MaintenanceRequest(
        ...
        validDates[2],
        2,
        validMaintenanceTypes[2],
        validEstimatedCompletion[2],
        validEstimatedCosts[2],
        true,
    ...
    new MaintenanceRequest(
        ...
        validDates[3],
        2,
        validMaintenanceTypes[3],
        validEstimatedCompletion[3],
        validEstimatedCosts[3],
        false,
